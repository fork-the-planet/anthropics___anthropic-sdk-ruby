  ...
  module Models
    module Beta
      class BetaWebhookDeploymentArchivedEventData < Anthropic::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, :"deployment.archived"]
        required :type, const: :"deployment.archived"
        ...
        # @!method initialize(id:, organization_id:, workspace_id:, type: :"deployment.archived")
        ...
        #
        #   @param type [Symbol, :"deployment.archived"]
      end
    end
