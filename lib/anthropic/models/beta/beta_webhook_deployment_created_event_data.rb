  ...
  module Models
    module Beta
      class BetaWebhookDeploymentCreatedEventData < Anthropic::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, :"deployment.created"]
        required :type, const: :"deployment.created"
        ...
        # @!method initialize(id:, organization_id:, workspace_id:, type: :"deployment.created")
        ...
        #
        #   @param type [Symbol, :"deployment.created"]
      end
    end
