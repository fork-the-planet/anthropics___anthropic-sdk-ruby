  ...
  module Models
    module Beta
      class BetaWebhookDeploymentUnpausedEventData < Anthropic::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, :"deployment.unpaused"]
        required :type, const: :"deployment.unpaused"
        ...
        # @!method initialize(id:, organization_id:, workspace_id:, type: :"deployment.unpaused")
        ...
        #
        #   @param type [Symbol, :"deployment.unpaused"]
      end
    end
